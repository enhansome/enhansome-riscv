...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,190 | 🐛 265 | 🌐 Scala | 📅 2026-08-14 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⭐ 4,329 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,843 | 🐛 343 | 🌐 Scala | 📅 2026-06-02 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,221 | 🐛 129 | 🌐 Assembly | 📅 2026-02-11 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,065 | 🐛 264 | 🌐 Assembly | 📅 2026-08-13 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,233 | 🐛 15 | 🌐 VHDL | 📅 2026-08-12 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,217 | 🐛 172 | 🌐 Scala | 📅 2026-08-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,009 | 🐛 259 | 🌐 SystemVerilog | 📅 2026-08-11 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
...
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,289 | 🐛 21 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,274 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-05-29 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,190 | 🐛 24 | 🌐 SystemVerilog | 📅 2026-07-15 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 749 | 🐛 233 | 🌐 Sail | 📅 2026-08-10 - RISCV Sail Model.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 58 | 🌐 SystemVerilog | 📅 2026-08-14 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 58 | 🌐 SystemVerilog | 📅 2026-08-14 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
* [Minerva](https://github.com/lambdaconcept/minerva) ⭐ 327 | 🐛 3 | 🌐 Python | 📅 2026-01-26 - 32-bit RISC-V soft processor.
* [SweRV EH2](https://github.com/chipsalliance/Cores-SweRV-EH2) ⭐ 275 | 🐛 16 | 🌐 SystemVerilog | 📅 2026-07-20 - EH2 SweRV RISC-V CoreTM 1.2 from Western Digital.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⭐ 4,329 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Simple example SoC using PicoRV32.
...
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,354 | 🐛 197 | 🌐 Scala | 📅 2026-07-29 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,726 | 🐛 140 | 🌐 C++ | 📅 2026-08-13 - Portable FPGA place and route tool.
* [PULPino](https://github.com/pulp-platform/pulpino) ⭐ 1,058 | 🐛 129 | 🌐 C | 📅 2024-02-06 - Single-core microcontroller system, based on 32-bit RISC-V cores.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,757 | 🐛 512 | 🌐 Scala | 📅 2026-08-13 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,568 | 🐛 0 | 🌐 C | 📅 2026-08-13 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,842 | 🐛 285 | 🌐 SystemVerilog | 📅 2026-08-14 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,378 | 🐛 90 | 🌐 C++ | 📅 2026-07-23 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,195 | 🐛 398 | 🌐 C | 📅 2026-08-14 - RISC-V ISA Simulator.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,754 | 🐛 190 | 🌐 C++ | 📅 2026-08-13 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [Renode](https://github.com/renode/renode) ⭐ 2,722 | 🐛 419 | 🌐 RobotFramework | 📅 2026-08-13 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,615 | 🐛 76 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,447 | 🐛 153 | 🌐 Python | 📅 2026-08-11 - Award-winning package manager and build tool set for HDL projects.
* [FireSim](https://github.com/firesim/firesim) ⭐ 1,032 | 🐛 240 | 🌐 Scala | 📅 2026-06-26 - Easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,342 | 🐛 163 | 🌐 Python | 📅 2026-04-03 - SV/UVM based open-source instruction generator for RISC-V processor verification.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,756 | 🐛 176 | 🌐 TeX | 📅 2026-08-14 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,378 | 🐛 90 | 🌐 C++ | 📅 2026-07-23 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,757 | 🐛 512 | 🌐 Scala | 📅 2026-08-13 - Community-contributed Chisel patterns and solutions wiki.
