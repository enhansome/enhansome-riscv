...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,242 | 🐛 274 | 🌐 Scala | 📅 2026-09-09 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,859 | 🐛 346 | 🌐 Scala | 📅 2026-06-02 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,245 | 🐛 131 | 🌐 Assembly | 📅 2026-09-08 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,097 | 🐛 263 | 🌐 Assembly | 📅 2026-09-08 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,258 | 🐛 10 | 🌐 VHDL | 📅 2026-09-09 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,233 | 🐛 171 | 🌐 Scala | 📅 2026-08-31 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,043 | 🐛 254 | 🌐 SystemVerilog | 📅 2026-09-08 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,881 | 🐛 36 | 🌐 Verilog | 📅 2026-08-25 - Award-winning ultra-compact bit-serial RISC-V core.
* [NutShell](https://github.com/OSCPU/NutShell) ⭐ 1,547 | 🐛 83 | 🌐 Scala | 📅 2026-09-07 - RISC-V processor developed by the University of Chinese Academy of Sciences.
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,518 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,304 | 🐛 21 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,286 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,199 | 🐛 37 | 🌐 SystemVerilog | 📅 2026-08-18 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
* [Freedom](https://github.com/sifive/freedom) ⚠️ Archived - By SiFive for its Freedom E300 and U500 platforms.
* [SCR1](https://github.com/syntacore/scr1) ⭐ 1,001 | 🐛 3 | 🌐 SystemVerilog | 📅 2024-11-15 - Free and open-source MCU-class RISC-V core from Syntacore.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 765 | 🐛 235 | 🌐 Sail | 📅 2026-09-08 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 619 | 🐛 36 | 🌐 SystemVerilog | 📅 2026-09-08 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
* [PULP](https://github.com/pulp-platform/pulp) ⭐ 568 | 🐛 40 | 🌐 SystemVerilog | 📅 2024-11-26 - Parallel Ultra-Low-Power open-source multi-core computing platform.
* [RV12](https://github.com/roalogic/RV12) ⭐ 447 | 🐛 14 | 🌐 SystemVerilog | 📅 2025-06-24 - Single-issue, in-order RV32I/RV64I RISC-V core from RoaLogic.
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-08 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-08 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
* [Minerva](https://github.com/lambdaconcept/minerva) ⭐ 327 | 🐛 3 | 🌐 Python | 📅 2026-01-26 - 32-bit RISC-V soft processor.
* [SweRV EH2](https://github.com/chipsalliance/Cores-SweRV-EH2) ⭐ 278 | 🐛 16 | 🌐 SystemVerilog | 📅 2026-09-04 - EH2 SweRV RISC-V CoreTM 1.2 from Western Digital.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⚠️ Archived - Simple example SoC using PicoRV32.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,602 | 🐛 43 | 🌐 C | 📅 2026-08-27 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,380 | 🐛 201 | 🌐 Scala | 📅 2026-09-08 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,751 | 🐛 148 | 🌐 C++ | 📅 2026-09-09 - Portable FPGA place and route tool.
...
* [LowRISC Chip](https://github.com/lowRISC/lowrisc-chip) ⭐ 600 | 🐛 49 | 🌐 SystemVerilog | 📅 2023-08-03 - lowRISC SoC platform built on the Rocket RISC-V core.
* [PULPissimo](https://github.com/pulp-platform/pulpissimo) ⭐ 496 | 🐛 138 | 🌐 SystemVerilog | 📅 2026-05-08 - Microcontroller architecture of the more recent PULP chips.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,778 | 🐛 513 | 🌐 Scala | 📅 2026-09-08 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,697 | 🐛 0 | 🌐 C | 📅 2026-09-08 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,916 | 🐛 293 | 🌐 SystemVerilog | 📅 2026-09-09 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,408 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,221 | 🐛 410 | 🌐 C | 📅 2026-09-02 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,863 | 🐛 439 | 🌐 RobotFramework | 📅 2026-09-08 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,799 | 🐛 197 | 🌐 C++ | 📅 2026-09-09 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,631 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,455 | 🐛 150 | 🌐 Python | 📅 2026-09-08 - Award-winning package manager and build tool set for HDL projects.
* [FireSim](https://github.com/firesim/firesim) ⭐ 1,040 | 🐛 239 | 🌐 Scala | 📅 2026-09-04 - Easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
* [RISC-V Formal](https://github.com/SymbioticEDA/riscv-formal) ⭐ 633 | 🐛 24 | 🌐 Verilog | 📅 2022-04-06 - Open-source formal verification framework for RISC-V processors.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,809 | 🐛 178 | 🌐 TeX | 📅 2026-09-08 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
* [Digital Design with Chisel](https://github.com/schoeberl/chisel-book) ⭐ 936 | 🐛 7 | 🌐 TeX | 📅 2026-09-08 - Open-source textbook on hardware design using Chisel, with free PDF available.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,408 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,778 | 🐛 513 | 🌐 Scala | 📅 2026-09-08 - Community-contributed Chisel patterns and solutions wiki.
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,153 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2024-09-10 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
