...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,239 | 🐛 269 | 🌐 Scala | 📅 2026-09-06 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⭐ 4,377 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Size-Optimized RISC-V CPU.
...
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,242 | 🐛 132 | 🌐 Assembly | 📅 2026-08-31 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,091 | 🐛 281 | 🌐 Assembly | 📅 2026-09-06 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [SERV](https://github.com/olofk/serv) ⭐ 1,880 | 🐛 36 | 🌐 Verilog | 📅 2026-08-25 - Award-winning ultra-compact bit-serial RISC-V core.
...
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,514 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,299 | 🐛 21 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,283 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 760 | 🐛 232 | 🌐 Sail | 📅 2026-09-05 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 614 | 🐛 32 | 🌐 SystemVerilog | 📅 2026-09-04 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [RV12](https://github.com/roalogic/RV12) ⭐ 445 | 🐛 6 | 🌐 SystemVerilog | 📅 2025-06-24 - Single-issue, in-order RV32I/RV64I RISC-V core from RoaLogic.
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 56 | 🌐 SystemVerilog | 📅 2026-09-04 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 56 | 🌐 SystemVerilog | 📅 2026-09-04 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⭐ 4,377 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Simple example SoC using PicoRV32.
...
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,745 | 🐛 150 | 🌐 C++ | 📅 2026-08-31 - Portable FPGA place and route tool.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,776 | 🐛 512 | 🌐 Scala | 📅 2026-09-04 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,686 | 🐛 0 | 🌐 C | 📅 2026-09-04 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,904 | 🐛 304 | 🌐 SystemVerilog | 📅 2026-09-05 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,405 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,220 | 🐛 406 | 🌐 C | 📅 2026-09-02 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,845 | 🐛 434 | 🌐 RobotFramework | 📅 2026-09-06 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,788 | 🐛 200 | 🌐 C++ | 📅 2026-09-03 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,352 | 🐛 167 | 🌐 Python | 📅 2026-09-04 - SV/UVM based open-source instruction generator for RISC-V processor verification.
...
* [UVM](https://github.com/SymbiFlow/uvm) ⭐ 137 | 🐛 1 | 🌐 SystemVerilog | 📅 2026-08-14 - Universal Verification Methodology (UVM) library for open-source EDA flows.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,804 | 🐛 179 | 🌐 TeX | 📅 2026-09-04 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,405 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,776 | 🐛 512 | 🌐 Scala | 📅 2026-09-04 - Community-contributed Chisel patterns and solutions wiki.
