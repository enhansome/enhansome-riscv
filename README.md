...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,256 | 🐛 275 | 🌐 Scala | 📅 2026-09-17 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,868 | 🐛 347 | 🌐 Scala | 📅 2026-09-13 - Parameterizable RISC-V SoC generator from UC Berkeley.
...
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,117 | 🐛 249 | 🌐 Assembly | 📅 2026-09-16 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,269 | 🐛 9 | 🌐 VHDL | 📅 2026-09-13 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,237 | 🐛 173 | 🌐 Scala | 📅 2026-09-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,059 | 🐛 259 | 🌐 SystemVerilog | 📅 2026-09-16 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
...
* [SweRV](https://github.com/chipsalliance/Cores-SweRV) ⭐ 967 | 🐛 29 | 🌐 SystemVerilog | 📅 2026-07-16 - EH1 SweRV RISC-V CoreTM 1.8 from Western Digital.
* [OpenPiton](https://github.com/PrincetonUniversity/openpiton) ⭐ 826 | 🐛 61 | 🌐 Assembly | 📅 2026-02-25 - World's first open source, general purpose, multithreaded manycore processor.
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 769 | 🐛 233 | 🌐 Sail | 📅 2026-09-16 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 627 | 🐛 38 | 🌐 SystemVerilog | 📅 2026-09-16 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-16 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-16 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,388 | 🐛 201 | 🌐 Scala | 📅 2026-09-13 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,754 | 🐛 141 | 🌐 C++ | 📅 2026-09-16 - Portable FPGA place and route tool.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,734 | 🐛 0 | 🌐 C | 📅 2026-09-17 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,933 | 🐛 296 | 🌐 SystemVerilog | 📅 2026-09-16 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,422 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,231 | 🐛 408 | 🌐 C | 📅 2026-09-17 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,903 | 🐛 450 | 🌐 RobotFramework | 📅 2026-09-17 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,814 | 🐛 202 | 🌐 C++ | 📅 2026-09-15 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,636 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,458 | 🐛 150 | 🌐 Python | 📅 2026-09-12 - Award-winning package manager and build tool set for HDL projects.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,354 | 🐛 168 | 🌐 Python | 📅 2026-09-04 - SV/UVM based open-source instruction generator for RISC-V processor verification.
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,243 | 🐛 145 | 🌐 Assembly | 📅 2026-09-16 - Unit tests for RISC-V processors.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,817 | 🐛 195 | 🌐 TeX | 📅 2026-09-17 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
* [Digital Design with Chisel](https://github.com/schoeberl/chisel-book) ⭐ 939 | 🐛 7 | 🌐 TeX | 📅 2026-09-12 - Open-source textbook on hardware design using Chisel, with free PDF available.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,422 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,158 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2024-09-10 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
