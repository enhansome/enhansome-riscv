...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,272 | 🐛 282 | 🌐 Scala | 📅 2026-09-23 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,868 | 🐛 353 | 🌐 Scala | 📅 2026-09-13 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,269 | 🐛 146 | 🌐 Assembly | 📅 2026-09-19 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,127 | 🐛 262 | 🌐 Assembly | 📅 2026-09-22 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,273 | 🐛 12 | 🌐 VHDL | 📅 2026-09-20 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,240 | 🐛 177 | 🌐 Scala | 📅 2026-09-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,065 | 🐛 261 | 🌐 SystemVerilog | 📅 2026-09-22 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
...
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,532 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,309 | 🐛 36 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,294 | 🐛 78 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,202 | 🐛 38 | 🌐 SystemVerilog | 📅 2026-09-21 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
* [Freedom](https://github.com/sifive/freedom) ⚠️ Archived - By SiFive for its Freedom E300 and U500 platforms.
* [SCR1](https://github.com/syntacore/scr1) ⭐ 1,003 | 🐛 3 | 🌐 SystemVerilog | 📅 2024-11-15 - Free and open-source MCU-class RISC-V core from Syntacore.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 775 | 🐛 231 | 🌐 Sail | 📅 2026-09-21 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 634 | 🐛 41 | 🌐 SystemVerilog | 📅 2026-09-22 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 345 | 🐛 53 | 🌐 SystemVerilog | 📅 2026-09-23 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 345 | 🐛 53 | 🌐 SystemVerilog | 📅 2026-09-23 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,618 | 🐛 44 | 🌐 C | 📅 2026-08-27 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,395 | 🐛 201 | 🌐 Scala | 📅 2026-09-21 - Framework for agile development of Chisel-based systems-on-chip.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,787 | 🐛 509 | 🌐 Scala | 📅 2026-09-22 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,754 | 🐛 0 | 🌐 C | 📅 2026-09-22 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,948 | 🐛 307 | 🌐 SystemVerilog | 📅 2026-09-23 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,425 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,233 | 🐛 402 | 🌐 C | 📅 2026-09-22 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,927 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-22 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,828 | 🐛 202 | 🌐 C++ | 📅 2026-09-23 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,644 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,463 | 🐛 152 | 🌐 Python | 📅 2026-09-12 - Award-winning package manager and build tool set for HDL projects.
* [FireSim](https://github.com/firesim/firesim) ⭐ 1,043 | 🐛 239 | 🌐 Scala | 📅 2026-09-10 - Easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
* [FireSim-NVDLA](https://github.com/CSL-KU/firesim-nvdla) ⭐ 167 | 🐛 20 | 🌐 Python | 📅 2022-01-16 - Full-system simulator integrated with NVIDIA Deep Learning Accelerator (NVDLA).
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,357 | 🐛 169 | 🌐 Python | 📅 2026-09-21 - SV/UVM based open-source instruction generator for RISC-V processor verification.
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,244 | 🐛 144 | 🌐 Assembly | 📅 2026-09-22 - Unit tests for RISC-V processors.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,818 | 🐛 189 | 🌐 TeX | 📅 2026-09-23 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,425 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,787 | 🐛 509 | 🌐 Scala | 📅 2026-09-22 - Community-contributed Chisel patterns and solutions wiki.
