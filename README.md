...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,204 | 🐛 264 | 🌐 Scala | 📅 2026-08-22 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⭐ 4,348 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Size-Optimized RISC-V CPU.
...
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,072 | 🐛 269 | 🌐 Assembly | 📅 2026-08-21 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,239 | 🐛 10 | 🌐 VHDL | 📅 2026-08-21 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,224 | 🐛 172 | 🌐 Scala | 📅 2026-08-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,021 | 🐛 265 | 🌐 SystemVerilog | 📅 2026-08-20 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,866 | 🐛 35 | 🌐 Verilog | 📅 2026-07-10 - Award-winning ultra-compact bit-serial RISC-V core.
...
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,276 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-05-29 - OpenHW Group CORE-V CV32E40P RISC-V IP.
...
* [SCR1](https://github.com/syntacore/scr1) ⭐ 997 | 🐛 2 | 🌐 SystemVerilog | 📅 2024-11-15 - Free and open-source MCU-class RISC-V core from Syntacore.
* [SweRV](https://github.com/chipsalliance/Cores-SweRV) ⭐ 962 | 🐛 28 | 🌐 SystemVerilog | 📅 2026-07-16 - EH1 SweRV RISC-V CoreTM 1.8 from Western Digital.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 748 | 🐛 243 | 🌐 Sail | 📅 2026-08-20 - RISCV Sail Model.
* [riscv-mini](https://github.com/ucb-bar/riscv-mini) ⚠️ Archived - Simple three-stage RISC-V pipeline written in Chisel.
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 606 | 🐛 31 | 🌐 SystemVerilog | 📅 2026-08-21 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 344 | 🐛 60 | 🌐 SystemVerilog | 📅 2026-08-21 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 344 | 🐛 60 | 🌐 SystemVerilog | 📅 2026-08-21 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⭐ 4,348 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Simple example SoC using PicoRV32.
...
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,362 | 🐛 197 | 🌐 Scala | 📅 2026-08-19 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,733 | 🐛 145 | 🌐 C++ | 📅 2026-08-20 - Portable FPGA place and route tool.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,600 | 🐛 0 | 🌐 C | 📅 2026-08-21 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,864 | 🐛 318 | 🌐 SystemVerilog | 📅 2026-08-21 - Fastest Verilog/SystemVerilog simulator.
...
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,201 | 🐛 404 | 🌐 C | 📅 2026-08-21 - RISC-V ISA Simulator.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,762 | 🐛 197 | 🌐 C++ | 📅 2026-08-21 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [Renode](https://github.com/renode/renode) ⭐ 2,754 | 🐛 424 | 🌐 RobotFramework | 📅 2026-08-21 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,615 | 🐛 76 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,452 | 🐛 154 | 🌐 Python | 📅 2026-08-21 - Award-winning package manager and build tool set for HDL projects.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,345 | 🐛 165 | 🌐 Python | 📅 2026-04-03 - SV/UVM based open-source instruction generator for RISC-V processor verification.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,770 | 🐛 178 | 🌐 TeX | 📅 2026-08-22 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
