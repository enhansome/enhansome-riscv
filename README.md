...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,253 | 🐛 288 | 🌐 Scala | 📅 2026-09-14 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,864 | 🐛 347 | 🌐 Scala | 📅 2026-09-13 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,252 | 🐛 134 | 🌐 Assembly | 📅 2026-09-08 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,109 | 🐛 245 | 🌐 Assembly | 📅 2026-09-13 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
* [E203](https://github.com/SI-RISCV/e200_opensource) ⚠️ Archived - Hummingbird E203 Opensource Processor Core.
* [DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,608 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04 - Experimental RISC-V implementation in Verilog, fitting in a small FPGA.
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,262 | 🐛 8 | 🌐 VHDL | 📅 2026-09-13 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,235 | 🐛 172 | 🌐 Scala | 📅 2026-09-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,051 | 🐛 260 | 🌐 SystemVerilog | 📅 2026-09-08 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,882 | 🐛 36 | 🌐 Verilog | 📅 2026-08-25 - Award-winning ultra-compact bit-serial RISC-V core.
* [NutShell](https://github.com/OSCPU/NutShell) ⭐ 1,549 | 🐛 83 | 🌐 Scala | 📅 2026-09-07 - RISC-V processor developed by the University of Chinese Academy of Sciences.
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,526 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,305 | 🐛 26 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,289 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,200 | 🐛 37 | 🌐 SystemVerilog | 📅 2026-09-14 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
...
* [OpenPiton](https://github.com/PrincetonUniversity/openpiton) ⭐ 825 | 🐛 61 | 🌐 Assembly | 📅 2026-02-25 - World's first open source, general purpose, multithreaded manycore processor.
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 769 | 🐛 232 | 🌐 Sail | 📅 2026-09-14 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 622 | 🐛 41 | 🌐 SystemVerilog | 📅 2026-09-14 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [RV12](https://github.com/roalogic/RV12) ⭐ 448 | 🐛 14 | 🌐 SystemVerilog | 📅 2025-06-24 - Single-issue, in-order RV32I/RV64I RISC-V core from RoaLogic.
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-11 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-11 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
* [Minerva](https://github.com/lambdaconcept/minerva) ⭐ 328 | 🐛 3 | 🌐 Python | 📅 2026-01-26 - 32-bit RISC-V soft processor.
* [SweRV EH2](https://github.com/chipsalliance/Cores-SweRV-EH2) ⭐ 279 | 🐛 16 | 🌐 SystemVerilog | 📅 2026-09-10 - EH2 SweRV RISC-V CoreTM 1.2 from Western Digital.
...
* [SSRV](https://github.com/risclite/SuperScalar-RISCV-CPU) ⭐ 237 | 🐛 3 | 🌐 SystemVerilog | 📅 2020-08-25 - SuperScalar-RISCV-CPU.
* [Steel](https://github.com/rafaelcalcada/steel-core) ⭐ 202 | 🐛 1 | 🌐 Verilog | 📅 2026-09-11 - Simple, 32-bit RISC-V processor core designed to be easily embedded into SoCs.
...
* [Kronos](https://github.com/SonalPinto/kronos) ⭐ 76 | 🐛 33 | 🌐 SystemVerilog | 📅 2023-05-15 - Lightweight, 3-stage in-order RV32I pipeline written in SystemVerilog.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,607 | 🐛 43 | 🌐 C | 📅 2026-08-27 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,386 | 🐛 201 | 🌐 Scala | 📅 2026-09-13 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,752 | 🐛 149 | 🌐 C++ | 📅 2026-09-13 - Portable FPGA place and route tool.
* [PULPino](https://github.com/pulp-platform/pulpino) ⭐ 1,066 | 🐛 130 | 🌐 C | 📅 2024-02-06 - Single-core microcontroller system, based on 32-bit RISC-V cores.
...
* [PULPissimo](https://github.com/pulp-platform/pulpissimo) ⭐ 498 | 🐛 138 | 🌐 SystemVerilog | 📅 2026-05-08 - Microcontroller architecture of the more recent PULP chips.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,781 | 🐛 510 | 🌐 Scala | 📅 2026-09-11 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,719 | 🐛 0 | 🌐 C | 📅 2026-09-14 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,928 | 🐛 295 | 🌐 SystemVerilog | 📅 2026-09-13 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,419 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,229 | 🐛 413 | 🌐 C | 📅 2026-09-11 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,881 | 🐛 443 | 🌐 RobotFramework | 📅 2026-09-11 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,808 | 🐛 200 | 🌐 C++ | 📅 2026-09-14 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,634 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,456 | 🐛 152 | 🌐 Python | 📅 2026-09-12 - Award-winning package manager and build tool set for HDL projects.
* [FireSim](https://github.com/firesim/firesim) ⭐ 1,041 | 🐛 239 | 🌐 Scala | 📅 2026-09-10 - Easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,242 | 🐛 145 | 🌐 Assembly | 📅 2026-08-14 - Unit tests for RISC-V processors.
...
* [UVM](https://github.com/SymbiFlow/uvm) ⭐ 139 | 🐛 1 | 🌐 SystemVerilog | 📅 2026-08-14 - Universal Verification Methodology (UVM) library for open-source EDA flows.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,813 | 🐛 190 | 🌐 TeX | 📅 2026-09-11 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
* [Digital Design with Chisel](https://github.com/schoeberl/chisel-book) ⭐ 937 | 🐛 7 | 🌐 TeX | 📅 2026-09-12 - Open-source textbook on hardware design using Chisel, with free PDF available.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,419 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,781 | 🐛 510 | 🌐 Scala | 📅 2026-09-11 - Community-contributed Chisel patterns and solutions wiki.
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,155 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2024-09-10 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
