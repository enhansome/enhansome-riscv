...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,203 | 🐛 266 | 🌐 Scala | 📅 2026-08-21 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⭐ 4,346 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Size-Optimized RISC-V CPU.
...
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,070 | 🐛 269 | 🌐 Assembly | 📅 2026-08-20 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,237 | 🐛 12 | 🌐 VHDL | 📅 2026-08-21 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,224 | 🐛 172 | 🌐 Scala | 📅 2026-08-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,018 | 🐛 264 | 🌐 SystemVerilog | 📅 2026-08-20 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
...
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,194 | 🐛 24 | 🌐 SystemVerilog | 📅 2026-08-18 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 748 | 🐛 238 | 🌐 Sail | 📅 2026-08-20 - RISCV Sail Model.
* [riscv-mini](https://github.com/ucb-bar/riscv-mini) ⚠️ Archived - Simple three-stage RISC-V pipeline written in Chisel.
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 605 | 🐛 31 | 🌐 SystemVerilog | 📅 2026-08-20 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 344 | 🐛 59 | 🌐 SystemVerilog | 📅 2026-08-20 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 344 | 🐛 59 | 🌐 SystemVerilog | 📅 2026-08-20 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [WARP-V](https://github.com/stevehoover/warp-v) ⭐ 252 | 🐛 17 | 🌐 TL-Verilog | 📅 2026-08-20 - Open-source RISC-V core IP you can shape to your needs.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⭐ 4,346 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Simple example SoC using PicoRV32.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,588 | 🐛 47 | 🌐 C | 📅 2026-08-20 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,360 | 🐛 197 | 🌐 Scala | 📅 2026-08-19 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,730 | 🐛 144 | 🌐 C++ | 📅 2026-08-20 - Portable FPGA place and route tool.
* [PULPino](https://github.com/pulp-platform/pulpino) ⭐ 1,060 | 🐛 129 | 🌐 C | 📅 2024-02-06 - Single-core microcontroller system, based on 32-bit RISC-V cores.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,596 | 🐛 0 | 🌐 C | 📅 2026-08-20 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,861 | 🐛 308 | 🌐 SystemVerilog | 📅 2026-08-20 - Fastest Verilog/SystemVerilog simulator.
...
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,201 | 🐛 400 | 🌐 C | 📅 2026-08-19 - RISC-V ISA Simulator.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,758 | 🐛 198 | 🌐 C++ | 📅 2026-08-20 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [Renode](https://github.com/renode/renode) ⭐ 2,752 | 🐛 422 | 🌐 RobotFramework | 📅 2026-08-20 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
...
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,232 | 🐛 144 | 🌐 Assembly | 📅 2026-08-14 - Unit tests for RISC-V processors.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,767 | 🐛 181 | 🌐 TeX | 📅 2026-08-20 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
