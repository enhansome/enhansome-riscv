...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,247 | 🐛 290 | 🌐 Scala | 📅 2026-09-11 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,863 | 🐛 346 | 🌐 Scala | 📅 2026-06-02 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,247 | 🐛 131 | 🌐 Assembly | 📅 2026-09-08 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,105 | 🐛 256 | 🌐 Assembly | 📅 2026-09-11 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
* [E203](https://github.com/SI-RISCV/e200_opensource) ⚠️ Archived - Hummingbird E203 Opensource Processor Core.
* [DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,605 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04 - Experimental RISC-V implementation in Verilog, fitting in a small FPGA.
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,258 | 🐛 11 | 🌐 VHDL | 📅 2026-09-09 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,233 | 🐛 172 | 🌐 Scala | 📅 2026-08-31 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,047 | 🐛 255 | 🌐 SystemVerilog | 📅 2026-09-08 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
...
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,522 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,304 | 🐛 21 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,287 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
...
* [OpenPiton](https://github.com/PrincetonUniversity/openpiton) ⭐ 823 | 🐛 61 | 🌐 Assembly | 📅 2026-02-25 - World's first open source, general purpose, multithreaded manycore processor.
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 766 | 🐛 233 | 🌐 Sail | 📅 2026-09-10 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 619 | 🐛 36 | 🌐 SystemVerilog | 📅 2026-09-10 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 51 | 🌐 SystemVerilog | 📅 2026-09-10 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 51 | 🌐 SystemVerilog | 📅 2026-09-10 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,384 | 🐛 201 | 🌐 Scala | 📅 2026-09-10 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,751 | 🐛 148 | 🌐 C++ | 📅 2026-09-10 - Portable FPGA place and route tool.
...
* [PULPissimo](https://github.com/pulp-platform/pulpissimo) ⭐ 497 | 🐛 138 | 🌐 SystemVerilog | 📅 2026-05-08 - Microcontroller architecture of the more recent PULP chips.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,778 | 🐛 510 | 🌐 Scala | 📅 2026-09-10 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,704 | 🐛 0 | 🌐 C | 📅 2026-09-11 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,920 | 🐛 294 | 🌐 SystemVerilog | 📅 2026-09-11 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,417 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,224 | 🐛 414 | 🌐 C | 📅 2026-09-02 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,872 | 🐛 441 | 🌐 RobotFramework | 📅 2026-09-10 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,803 | 🐛 200 | 🌐 C++ | 📅 2026-09-11 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,631 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,456 | 🐛 151 | 🌐 Python | 📅 2026-09-08 - Award-winning package manager and build tool set for HDL projects.
* [FireSim](https://github.com/firesim/firesim) ⭐ 1,040 | 🐛 239 | 🌐 Scala | 📅 2026-09-10 - Easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
...
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,241 | 🐛 145 | 🌐 Assembly | 📅 2026-08-14 - Unit tests for RISC-V processors.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,812 | 🐛 179 | 🌐 TeX | 📅 2026-09-11 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,417 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,778 | 🐛 510 | 🌐 Scala | 📅 2026-09-10 - Community-contributed Chisel patterns and solutions wiki.
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,154 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2024-09-10 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
