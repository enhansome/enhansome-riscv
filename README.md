...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,239 | 🐛 277 | 🌐 Scala | 📅 2026-09-07 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⭐ 4,380 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,854 | 🐛 345 | 🌐 Scala | 📅 2026-06-02 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,243 | 🐛 132 | 🌐 Assembly | 📅 2026-08-31 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,091 | 🐛 275 | 🌐 Assembly | 📅 2026-09-07 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
* [E203](https://github.com/SI-RISCV/e200_opensource) ⚠️ Archived - Hummingbird E203 Opensource Processor Core.
* [DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,604 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04 - Experimental RISC-V implementation in Verilog, fitting in a small FPGA.
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,254 | 🐛 9 | 🌐 VHDL | 📅 2026-09-06 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,229 | 🐛 170 | 🌐 Scala | 📅 2026-08-31 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,035 | 🐛 255 | 🌐 SystemVerilog | 📅 2026-08-31 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,881 | 🐛 36 | 🌐 Verilog | 📅 2026-08-25 - Award-winning ultra-compact bit-serial RISC-V core.
* [NutShell](https://github.com/OSCPU/NutShell) ⭐ 1,545 | 🐛 85 | 🌐 Scala | 📅 2026-08-18 - RISC-V processor developed by the University of Chinese Academy of Sciences.
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,515 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,300 | 🐛 21 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,285 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,197 | 🐛 37 | 🌐 SystemVerilog | 📅 2026-08-18 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
* [Freedom](https://github.com/sifive/freedom) ⚠️ Archived - By SiFive for its Freedom E300 and U500 platforms.
* [SCR1](https://github.com/syntacore/scr1) ⭐ 1,000 | 🐛 2 | 🌐 SystemVerilog | 📅 2024-11-15 - Free and open-source MCU-class RISC-V core from Syntacore.
* [SweRV](https://github.com/chipsalliance/Cores-SweRV) ⭐ 966 | 🐛 29 | 🌐 SystemVerilog | 📅 2026-07-16 - EH1 SweRV RISC-V CoreTM 1.8 from Western Digital.
* [OpenPiton](https://github.com/PrincetonUniversity/openpiton) ⭐ 818 | 🐛 61 | 🌐 Assembly | 📅 2026-02-25 - World's first open source, general purpose, multithreaded manycore processor.
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 761 | 🐛 232 | 🌐 Sail | 📅 2026-09-07 - RISCV Sail Model.
* [Sodor](https://github.com/ucb-bar/riscv-sodor) ⭐ 755 | 🐛 15 | 🌐 Scala | 📅 2025-09-01 - Educational collection of simple RISC-V processors written in Chisel by UC Berkeley.
* [riscv-mini](https://github.com/ucb-bar/riscv-mini) ⚠️ Archived - Simple three-stage RISC-V pipeline written in Chisel.
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 616 | 🐛 36 | 🌐 SystemVerilog | 📅 2026-09-04 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
* [PULP](https://github.com/pulp-platform/pulp) ⭐ 568 | 🐛 39 | 🌐 SystemVerilog | 📅 2024-11-26 - Parallel Ultra-Low-Power open-source multi-core computing platform.
* [RV12](https://github.com/roalogic/RV12) ⭐ 445 | 🐛 10 | 🌐 SystemVerilog | 📅 2025-06-24 - Single-issue, in-order RV32I/RV64I RISC-V core from RoaLogic.
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 55 | 🌐 SystemVerilog | 📅 2026-09-07 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 55 | 🌐 SystemVerilog | 📅 2026-09-07 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
* [Minerva](https://github.com/lambdaconcept/minerva) ⭐ 327 | 🐛 3 | 🌐 Python | 📅 2026-01-26 - 32-bit RISC-V soft processor.
* [SweRV EH2](https://github.com/chipsalliance/Cores-SweRV-EH2) ⭐ 276 | 🐛 16 | 🌐 SystemVerilog | 📅 2026-09-04 - EH2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [WARP-V](https://github.com/stevehoover/warp-v) ⭐ 255 | 🐛 17 | 🌐 TL-Verilog | 📅 2026-08-27 - Open-source RISC-V core IP you can shape to your needs.
* [SSRV](https://github.com/risclite/SuperScalar-RISCV-CPU) ⭐ 236 | 🐛 3 | 🌐 SystemVerilog | 📅 2020-08-25 - SuperScalar-RISCV-CPU.
* [Steel](https://github.com/rafaelcalcada/steel-core) ⭐ 202 | 🐛 1 | 🌐 Verilog | 📅 2026-09-01 - Simple, 32-bit RISC-V processor core designed to be easily embedded into SoCs.
...
* [mriscv](https://github.com/onchipuis/mriscv) ⭐ 165 | 🐛 1 | 🌐 Verilog | 📅 2018-02-28 - 32-bit pipelined RISC-V processor implemented in Verilog.
...
* [Kronos](https://github.com/SonalPinto/kronos) ⭐ 76 | 🐛 31 | 🌐 SystemVerilog | 📅 2023-05-15 - Lightweight, 3-stage in-order RV32I pipeline written in SystemVerilog.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⭐ 4,380 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Simple example SoC using PicoRV32.
...
* [Raven](https://github.com/efabless/raven-picorv32) ⭐ 297 | 🐛 4 | 🌐 Verilog | 📅 2020-07-28 - ASIC implementation of the PicoSoC PicoRV32.
* [Iob-SoC](https://github.com/IObundle/iob-soc) ⭐ 161 | 🐛 0 | 🌐 Makefile | 📅 2026-08-26 - Template for building RISC-V-based SoCs using open-source tools.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,600 | 🐛 43 | 🌐 C | 📅 2026-08-27 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,379 | 🐛 202 | 🌐 Scala | 📅 2026-08-19 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,747 | 🐛 147 | 🌐 C++ | 📅 2026-09-06 - Portable FPGA place and route tool.
* [PULPino](https://github.com/pulp-platform/pulpino) ⭐ 1,064 | 🐛 130 | 🌐 C | 📅 2024-02-06 - Single-core microcontroller system, based on 32-bit RISC-V cores.
...
* [PULPissimo](https://github.com/pulp-platform/pulpissimo) ⭐ 495 | 🐛 138 | 🌐 SystemVerilog | 📅 2026-05-08 - Microcontroller architecture of the more recent PULP chips.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,777 | 🐛 512 | 🌐 Scala | 📅 2026-09-04 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,690 | 🐛 0 | 🌐 C | 📅 2026-09-06 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,908 | 🐛 298 | 🌐 SystemVerilog | 📅 2026-09-07 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,406 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,220 | 🐛 406 | 🌐 C | 📅 2026-09-02 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,853 | 🐛 435 | 🌐 RobotFramework | 📅 2026-09-06 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,793 | 🐛 202 | 🌐 C++ | 📅 2026-09-03 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,631 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,454 | 🐛 153 | 🌐 Python | 📅 2026-08-24 - Award-winning package manager and build tool set for HDL projects.
* [FireSim](https://github.com/firesim/firesim) ⭐ 1,039 | 🐛 239 | 🌐 Scala | 📅 2026-09-04 - Easy-to-use, Scalable, FPGA-accelerated Cycle-accurate Hardware Simulation.
* [Dromajo](https://github.com/chipsalliance/dromajo) ⭐ 245 | 🐛 26 | 🌐 C++ | 📅 2024-11-20 - Esperanto Technology's RISC-V Reference Model.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,353 | 🐛 167 | 🌐 Python | 📅 2026-09-04 - SV/UVM based open-source instruction generator for RISC-V processor verification.
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,239 | 🐛 145 | 🌐 Assembly | 📅 2026-08-14 - Unit tests for RISC-V processors.
...
* [UVM](https://github.com/SymbiFlow/uvm) ⭐ 138 | 🐛 1 | 🌐 SystemVerilog | 📅 2026-08-14 - Universal Verification Methodology (UVM) library for open-source EDA flows.
...
* [BOOM Attacks](https://github.com/riscv-boom/boom-attacks) ⭐ 70 | 🐛 3 | 🌐 C | 📅 2019-10-18 - BOOM Speculative Attacks.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,804 | 🐛 180 | 🌐 TeX | 📅 2026-09-04 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
* [Digital Design with Chisel](https://github.com/schoeberl/chisel-book) ⭐ 932 | 🐛 7 | 🌐 TeX | 📅 2026-08-31 - Open-source textbook on hardware design using Chisel, with free PDF available.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,406 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,777 | 🐛 512 | 🌐 Scala | 📅 2026-09-04 - Community-contributed Chisel patterns and solutions wiki.
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,151 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2024-09-10 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
