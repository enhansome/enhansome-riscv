...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,275 | 🐛 278 | 🌐 Scala | 📅 2026-09-25 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,873 | 🐛 355 | 🌐 Scala | 📅 2026-09-13 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,273 | 🐛 145 | 🌐 Assembly | 📅 2026-09-24 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,129 | 🐛 265 | 🌐 Assembly | 📅 2026-09-25 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,279 | 🐛 12 | 🌐 VHDL | 📅 2026-09-20 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,245 | 🐛 179 | 🌐 Scala | 📅 2026-09-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,068 | 🐛 266 | 🌐 SystemVerilog | 📅 2026-09-25 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,887 | 🐛 36 | 🌐 Verilog | 📅 2026-08-25 - Award-winning ultra-compact bit-serial RISC-V core.
* [NutShell](https://github.com/OSCPU/NutShell) ⭐ 1,554 | 🐛 83 | 🌐 Scala | 📅 2026-09-22 - RISC-V processor developed by the University of Chinese Academy of Sciences.
...
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,311 | 🐛 36 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,299 | 🐛 80 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,204 | 🐛 38 | 🌐 SystemVerilog | 📅 2026-09-21 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 775 | 🐛 231 | 🌐 Sail | 📅 2026-09-25 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 637 | 🐛 40 | 🌐 SystemVerilog | 📅 2026-09-24 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 346 | 🐛 59 | 🌐 SystemVerilog | 📅 2026-09-25 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 346 | 🐛 59 | 🌐 SystemVerilog | 📅 2026-09-25 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
* [Minerva](https://github.com/lambdaconcept/minerva) ⭐ 327 | 🐛 3 | 🌐 Python | 📅 2026-01-26 - 32-bit RISC-V soft processor.
* [SweRV EH2](https://github.com/chipsalliance/Cores-SweRV-EH2) ⭐ 280 | 🐛 16 | 🌐 SystemVerilog | 📅 2026-09-17 - EH2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [WARP-V](https://github.com/stevehoover/warp-v) ⭐ 255 | 🐛 17 | 🌐 TL-Verilog | 📅 2026-09-24 - Open-source RISC-V core IP you can shape to your needs.
...
* [Raven](https://github.com/efabless/raven-picorv32) ⭐ 298 | 🐛 4 | 🌐 Verilog | 📅 2020-07-28 - ASIC implementation of the PicoSoC PicoRV32.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,623 | 🐛 44 | 🌐 C | 📅 2026-08-27 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,399 | 🐛 201 | 🌐 Scala | 📅 2026-09-25 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,756 | 🐛 144 | 🌐 C++ | 📅 2026-09-25 - Portable FPGA place and route tool.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,791 | 🐛 513 | 🌐 Scala | 📅 2026-09-25 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,765 | 🐛 0 | 🌐 C | 📅 2026-09-25 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,957 | 🐛 309 | 🌐 SystemVerilog | 📅 2026-09-25 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,435 | 🐛 89 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,235 | 🐛 402 | 🌐 C | 📅 2026-09-25 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,938 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-25 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,836 | 🐛 203 | 🌐 C++ | 📅 2026-09-25 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,645 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,463 | 🐛 153 | 🌐 Python | 📅 2026-09-25 - Award-winning package manager and build tool set for HDL projects.
...
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,245 | 🐛 144 | 🌐 Assembly | 📅 2026-09-25 - Unit tests for RISC-V processors.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,823 | 🐛 186 | 🌐 TeX | 📅 2026-09-26 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,435 | 🐛 89 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,791 | 🐛 513 | 🌐 Scala | 📅 2026-09-25 - Community-contributed Chisel patterns and solutions wiki.
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,161 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
...
* [How I built a RISC-V CPU Core in a span of 5 days](https://github.com/iamrk-vlsi/RISC-V-MYTH-Workshop) ⭐ 14 | 🐛 0 | 🌐 C | 📅 2022-02-02 - Workshop repository documenting a hands-on RISC-V TL-Verilog CPU build in five days.
