...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,194 | 🐛 273 | 🌐 Scala | 📅 2026-08-17 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⭐ 4,335 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,846 | 🐛 344 | 🌐 Scala | 📅 2026-06-02 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,224 | 🐛 130 | 🌐 Assembly | 📅 2026-02-11 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,067 | 🐛 262 | 🌐 Assembly | 📅 2026-08-16 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
...
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,237 | 🐛 12 | 🌐 VHDL | 📅 2026-08-16 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,218 | 🐛 172 | 🌐 Scala | 📅 2026-08-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,014 | 🐛 261 | 🌐 SystemVerilog | 📅 2026-08-11 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,862 | 🐛 35 | 🌐 Verilog | 📅 2026-07-10 - Award-winning ultra-compact bit-serial RISC-V core.
* [NutShell](https://github.com/OSCPU/NutShell) ⭐ 1,544 | 🐛 76 | 🌐 Scala | 📅 2026-06-05 - RISC-V processor developed by the University of Chinese Academy of Sciences.
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,509 | 🐛 9 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,290 | 🐛 21 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,275 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-05-29 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,192 | 🐛 24 | 🌐 SystemVerilog | 📅 2026-07-15 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
* [Freedom](https://github.com/sifive/freedom) ⚠️ Archived - By SiFive for its Freedom E300 and U500 platforms.
* [SCR1](https://github.com/syntacore/scr1) ⭐ 994 | 🐛 2 | 🌐 SystemVerilog | 📅 2024-11-15 - Free and open-source MCU-class RISC-V core from Syntacore.
...
* [OpenPiton](https://github.com/PrincetonUniversity/openpiton) ⭐ 810 | 🐛 60 | 🌐 Assembly | 📅 2026-02-25 - World's first open source, general purpose, multithreaded manycore processor.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 748 | 🐛 235 | 🌐 Sail | 📅 2026-08-14 - RISCV Sail Model.
* [riscv-mini](https://github.com/ucb-bar/riscv-mini) ⚠️ Archived - Simple three-stage RISC-V pipeline written in Chisel.
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 600 | 🐛 30 | 🌐 SystemVerilog | 📅 2026-07-19 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
* [PULP](https://github.com/pulp-platform/pulp) ⭐ 567 | 🐛 39 | 🌐 SystemVerilog | 📅 2024-11-26 - Parallel Ultra-Low-Power open-source multi-core computing platform.
...
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 344 | 🐛 58 | 🌐 SystemVerilog | 📅 2026-08-17 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 344 | 🐛 58 | 🌐 SystemVerilog | 📅 2026-08-17 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [PicoSoC](https://github.com/cliffordwolf/picorv32/tree/master/picosoc) ⭐ 4,335 | 🐛 87 | 🌐 Verilog | 📅 2026-07-31 - Simple example SoC using PicoRV32.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,585 | 🐛 47 | 🌐 C | 📅 2026-08-12 - RISC-V GNU Compiler Toolchain.
* [Chipyard](https://github.com/ucb-bar/chipyard) ⭐ 2,355 | 🐛 199 | 🌐 Scala | 📅 2026-08-15 - Framework for agile development of Chisel-based systems-on-chip.
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,729 | 🐛 141 | 🌐 C++ | 📅 2026-08-15 - Portable FPGA place and route tool.
* [PULPino](https://github.com/pulp-platform/pulpino) ⭐ 1,059 | 🐛 129 | 🌐 C | 📅 2024-02-06 - Single-core microcontroller system, based on 32-bit RISC-V cores.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,760 | 🐛 512 | 🌐 Scala | 📅 2026-08-17 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,579 | 🐛 0 | 🌐 C | 📅 2026-08-16 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,850 | 🐛 296 | 🌐 SystemVerilog | 📅 2026-08-16 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,381 | 🐛 90 | 🌐 C++ | 📅 2026-07-23 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,197 | 🐛 397 | 🌐 C | 📅 2026-08-14 - RISC-V ISA Simulator.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,756 | 🐛 187 | 🌐 C++ | 📅 2026-08-15 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [Renode](https://github.com/renode/renode) ⭐ 2,740 | 🐛 422 | 🌐 RobotFramework | 📅 2026-08-14 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,615 | 🐛 76 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,450 | 🐛 153 | 🌐 Python | 📅 2026-08-11 - Award-winning package manager and build tool set for HDL projects.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,344 | 🐛 163 | 🌐 Python | 📅 2026-04-03 - SV/UVM based open-source instruction generator for RISC-V processor verification.
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,229 | 🐛 144 | 🌐 Assembly | 📅 2026-08-14 - Unit tests for RISC-V processors.
...
* [UVM](https://github.com/SymbiFlow/uvm) ⭐ 135 | 🐛 1 | 🌐 SystemVerilog | 📅 2026-08-14 - Universal Verification Methodology (UVM) library for open-source EDA flows.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,761 | 🐛 177 | 🌐 TeX | 📅 2026-08-14 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,381 | 🐛 90 | 🌐 C++ | 📅 2026-07-23 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,760 | 🐛 512 | 🌐 Scala | 📅 2026-08-17 - Community-contributed Chisel patterns and solutions wiki.
