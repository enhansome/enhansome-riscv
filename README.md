...
* [XiangShan](https://github.com/OpenXiangShan/XiangShan) ⭐ 7,254 | 🐛 272 | 🌐 Scala | 📅 2026-09-16 - Open-source high-performance out-of-order RISC-V processor developed at the Institute of Computing Technology, Chinese Academy of Sciences.
* [PicoRV32](https://github.com/cliffordwolf/picorv32) ⚠️ Archived - Size-Optimized RISC-V CPU.
* [Rocket](https://github.com/chipsalliance/rocket-chip) ⭐ 3,865 | 🐛 347 | 🌐 Scala | 📅 2026-09-13 - Parameterizable RISC-V SoC generator from UC Berkeley.
* [VexRiscv](https://github.com/SpinalHDL/VexRiscv) ⭐ 3,261 | 🐛 134 | 🌐 Assembly | 📅 2026-09-08 - FPGA-friendly 32-bit RISC-V implementation written in SpinalHDL.
* [CVA6](https://github.com/openhwgroup/cva6) ⭐ 3,114 | 🐛 242 | 🌐 Assembly | 📅 2026-09-16 - 6-stage, single-issue in-order RISC-V core maintained by the OpenHW Group.
* [E203](https://github.com/SI-RISCV/e200_opensource) ⚠️ Archived - Hummingbird E203 Opensource Processor Core.
* [DarkRISCV](https://github.com/darklife/darkriscv) ⭐ 2,610 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04 - Experimental RISC-V implementation in Verilog, fitting in a small FPGA.
* [NEORV32](https://github.com/stnolting/neorv32) ⭐ 2,267 | 🐛 8 | 🌐 VHDL | 📅 2026-09-13 - Customizable, extensible MCU-class 32-bit soft-core CPU and SoC written in VHDL.
* [BOOM](https://github.com/riscv-boom/riscv-boom) ⭐ 2,236 | 🐛 173 | 🌐 Scala | 📅 2026-09-11 - Berkeley Out-of-Order RISC-V Processor.
* [Ibex](https://github.com/lowRISC/ibex) ⭐ 2,058 | 🐛 260 | 🌐 SystemVerilog | 📅 2026-09-15 - Small, 32-bit RISC-V core from lowRISC, formally verified and production-proven.
* [SERV](https://github.com/olofk/serv) ⭐ 1,883 | 🐛 36 | 🌐 Verilog | 📅 2026-08-25 - Award-winning ultra-compact bit-serial RISC-V core.
* [NutShell](https://github.com/OSCPU/NutShell) ⭐ 1,549 | 🐛 83 | 🌐 Scala | 📅 2026-09-16 - RISC-V processor developed by the University of Chinese Academy of Sciences.
* [Tiny Risc-V](https://github.com/liangkangnan/tinyriscv) ⭐ 1,528 | 🐛 16 | 🌐 C | 📅 2023-11-09 - Easy-to-understand, from-scratch RISC-V implementation written in Verilog.
* [biRISC-V](https://github.com/ultraembedded/biriscv) ⭐ 1,307 | 🐛 36 | 🌐 Verilog | 📅 2021-09-18 - 32-bit dual-issue in-order RISC-V CPU.
* [CV32E40P](https://github.com/openhwgroup/cv32e40p) ⭐ 1,290 | 🐛 77 | 🌐 SystemVerilog | 📅 2026-08-26 - OpenHW Group CORE-V CV32E40P RISC-V IP.
* [RSD](https://github.com/rsd-devel/rsd) ⭐ 1,201 | 🐛 37 | 🌐 SystemVerilog | 📅 2026-09-16 - Out-of-order superscalar RISC-V processor written in SystemVerilog.
...
* [Sail RISC-V](https://github.com/rems-project/sail-riscv) ⭐ 769 | 🐛 236 | 🌐 Sail | 📅 2026-09-15 - RISCV Sail Model.
...
* [Wally (CVW)](https://github.com/openhwgroup/cvw) ⭐ 627 | 🐛 33 | 🌐 SystemVerilog | 📅 2026-09-16 - CORE-V Wally: a configurable, 5-stage-pipeline RISC-V processor associated with the *RISC-V System-on-Chip Design* textbook by Harris et al.
...
* [RV12](https://github.com/roalogic/RV12) ⭐ 449 | 🐛 14 | 🌐 SystemVerilog | 📅 2025-06-24 - Single-issue, in-order RV32I/RV64I RISC-V core from RoaLogic.
* [SweRV EL2](https://github.com/chipsalliance/Cores-SweRV-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-15 - EL2 SweRV RISC-V CoreTM 1.2 from Western Digital.
* [VeeR EL2](https://github.com/chipsalliance/Cores-VeeR-EL2) ⭐ 343 | 🐛 52 | 🌐 SystemVerilog | 📅 2026-09-15 - CHIPS Alliance VeeR EL2 RISC-V Core; the actively maintained successor to the Western Digital SweRV family.
...
* [Iob-SoC](https://github.com/IObundle/iob-soc) ⭐ 162 | 🐛 0 | 🌐 Makefile | 📅 2026-08-26 - Template for building RISC-V-based SoCs using open-source tools.
...
* [RISC-V GNU Toolchain](https://github.com/riscv/riscv-gnu-toolchain) ⭐ 4,611 | 🐛 44 | 🌐 C | 📅 2026-08-27 - RISC-V GNU Compiler Toolchain.
...
* [nextpnr](https://github.com/YosysHQ/nextpnr) ⭐ 1,752 | 🐛 143 | 🌐 C++ | 📅 2026-09-13 - Portable FPGA place and route tool.
...
* [CHISEL](https://github.com/freechipsproject/chisel3) ⭐ 4,785 | 🐛 510 | 🌐 Scala | 📅 2026-09-11 - Hardware Design Language that facilitates advanced circuit generation and design reuse in Scala.
...
* [QEMU](https://github.com/qemu/qemu) ⭐ 13,730 | 🐛 0 | 🌐 C | 📅 2026-09-16 - The leading open-source machine emulator and virtualizer; supports both RV32 and RV64 system and user-mode emulation.
* [Verilator](https://github.com/verilator/verilator) ⭐ 3,931 | 🐛 294 | 🌐 SystemVerilog | 📅 2026-09-16 - Fastest Verilog/SystemVerilog simulator.
* [Ripes](https://github.com/mortbopet/Ripes) ⭐ 3,420 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Visual computer architecture simulator and assembly code editor.
* [Spike](https://github.com/riscv/riscv-isa-sim/) ⭐ 3,230 | 🐛 414 | 🌐 C | 📅 2026-09-11 - RISC-V ISA Simulator.
* [Renode](https://github.com/renode/renode) ⭐ 2,895 | 🐛 446 | 🌐 RobotFramework | 📅 2026-09-15 - Antmicro's open-source simulation framework with excellent RISC-V support; ideal for embedded and multi-core prototyping.
* [gem5](https://github.com/gem5/gem5) ⭐ 2,812 | 🐛 201 | 🌐 C++ | 📅 2026-09-15 - The gem5 computer-system architecture simulator; widely used in academia for RISC-V microarchitecture research.
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,635 | 🐛 77 | 🌐 Java | 📅 2024-07-19 - RISC-V Assembler and Runtime Simulator.
* [FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,457 | 🐛 150 | 🌐 Python | 📅 2026-09-12 - Award-winning package manager and build tool set for HDL projects.
...
* [RISC-V DV](https://github.com/google/riscv-dv) ⭐ 1,354 | 🐛 167 | 🌐 Python | 📅 2026-09-04 - SV/UVM based open-source instruction generator for RISC-V processor verification.
* [RISC-V Tests](https://github.com/riscv/riscv-tests) ⭐ 1,243 | 🐛 145 | 🌐 Assembly | 📅 2026-08-14 - Unit tests for RISC-V processors.
...
* [UVM](https://github.com/SymbiFlow/uvm) ⭐ 140 | 🐛 1 | 🌐 SystemVerilog | 📅 2026-08-14 - Universal Verification Methodology (UVM) library for open-source EDA flows.
...
* [RISC-V ISA Specification Manual](https://github.com/riscv/riscv-isa-manual) ⭐ 4,817 | 🐛 196 | 🌐 TeX | 📅 2026-09-15 - The official, open-source RISC-V Instruction Set Manual (Volumes I & II); the definitive reference for the unprivileged and privileged ISA.
* [Digital Design with Chisel](https://github.com/schoeberl/chisel-book) ⭐ 938 | 🐛 7 | 🌐 TeX | 📅 2026-09-12 - Open-source textbook on hardware design using Chisel, with free PDF available.
...
* [Ripes Wiki](https://github.com/mortbopet/Ripes/wiki/Ripes-Introduction) ⭐ 3,420 | 🐛 88 | 🌐 C++ | 📅 2026-08-18 - Official wiki and introduction for the Ripes RISC-V visual simulator.
...
* [Cookbook](https://github.com/freechipsproject/chisel3/wiki/Cookbook) ⭐ 4,785 | 🐛 510 | 🌐 Scala | 📅 2026-09-11 - Community-contributed Chisel patterns and solutions wiki.
* [CHISEL Bootcamp](https://github.com/freechipsproject/chisel-bootcamp) ⭐ 1,157 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2024-09-10 - Interactive Jupyter-notebook-based bootcamp for learning Chisel hardware design.
